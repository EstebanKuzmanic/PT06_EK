...
tf=8.2 #ESTO HAY QUE ARREGLARLO O VER OTRA FORMA DE HACERLO
dt=0.0001
t=np.arange(0,tf,dt)
...
def current(t):
    return stepTime(0,te,t)*-0.25*cbat+stepTime(te,2*te,t)*-0.15*cbat+stepTime(2*te,3*te,t)*-0.1*cbat+stepTime(3*te,4*te,t)*-0.05*cbat+stepTime(4*te,5*te,t)*-0.01*cbat
